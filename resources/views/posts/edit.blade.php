                        ...
                        <form action="{{ route('posts.update', $post->id) }}" method="PUT" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control  @error('title') is-invalid @enderror"
                                    name="title" value="{{ old('title', $post->title) }}" placeholder="Masukkan judul produk">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('price') is-invalid @enderror"
                                    value="{{ old('price', $post->price) }}" placeholder="Masukkan harga produk"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('stock') is-invalid @enderror"
                                    value="{{ old('stock', $post->stock) }}" placeholder="Masukkan stok produk"
